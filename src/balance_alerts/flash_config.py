...
FLASH_ACCOUNTS: dict[str, FlashAccount] = {
    # ── CASH ────────────────────────────────────────────────────────────────
    "db7bd804-8ad1-4969-bfef-54fd03cd70fe": FlashAccount("PF-Access America", "cash"),
    "ad0159d4-f0df-43ed-b45e-f6742dad69e7": FlashAccount("CH-Sparks Checking", "cash"),
    # Template said CH-, but this account's broker is PenFed → PF- (confirmed
    # inconsistency, flagged 2026-08-02).
    "113a1462-94a3-40ed-8199-79ebbf24d814": FlashAccount("PF-Regular Savings", "cash"),
    "e287c52d-3b1f-47a3-b748-d1595f3d56ea": FlashAccount("PF-MM Savings", "cash"),
    # ── CREDIT ──────────────────────────────────────────────────────────────
    "aec8a7e1-a5d4-486f-b75f-52e8f5069235": FlashAccount("Atmos Ascent Visa", "credit"),
    ...
    "ab2d72b2-d45b-437a-9ba1-95dd73902834": FlashAccount("Schwab AMZN", "stocks"),
    "4ea987d2-ft-8291": FlashAccount("Templeton Growth", "stocks"),
    # ── RETIREMENT ──────────────────────────────────────────────────────────
