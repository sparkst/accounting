...
class TestDetectCurrency:
    ...
    def test_eur_symbol(self):
        ...
        assert len(result) == 1
        assert result[0].amount == Decimal("25")
...
class TestFetchExchangeRate:
    ...
    def test_successful_fetch(self):
        ...
        assert result.rate == Decimal("1.3603")
...
class TestConvertToUSD:
    ...
    def test_successful_conversion(self):
        ...
        assert result is not None
        assert result.usd_amount == Decimal("6.79")
        assert result.rate == Decimal("1.36")
        assert result.source == "frankfurter_api"
    ...
    def test_usd_identity(self):
        ...
        assert result is not None
        assert result.usd_amount == Decimal("100.0")
...
class TestBackfillLogic:
    ...
    def test_detect_currency_in_ba_email(self):
        ...
        assert hits[0].amount == Decimal("4.99")
